...
const MESSAGES: Record<SiloLang, Record<string, string>> = {
  ko: {
    ...
    'signup.codePlaceholder': '가입 코드 (8자리)',
    'signup.submit': '가입',
    'signup.failed': '가입 실패',
    ...
    'prof.ipGuard.title': 'IP 화이트리스트 사용',
    'prof.ipGuard.note': '끄면 사용자별 허용 IP 검증을 생략합니다. Render 등 프록시 뒤에서 실제 IP 판별이 어려운 환경에서는 끄세요.',
    'prof.ipGuard.on': 'IP 화이트리스트가 활성화되었습니다.',
    'prof.ipGuard.off': 'IP 화이트리스트가 비활성화되었습니다. (모든 IP 허용)',
    'prof.save': '저장',
    'prof.saving': '저장 중...',
    ...
    'proj.extra.title': '페이지별 추가 지식',
    'proj.extra.note': '크롤링으로 놓쳤거나 사이트에 아직 없는 최신 정보(이벤트·가격·예약 규정 등)를 페이지별로 추가하세요. 저장 즉시 AI 비서의 자유 질문과 페이지 검색 답변에 반영됩니다.',
    'proj.extra.placeholder': '예: 2026년 9월 이벤트 — 첫 상담 무료. 예약은 카카오톡 채널 "OO"으로 신청.',
    'proj.extra.save': '추가 지식 저장',
    'proj.extra.saving': '저장 중...',
    'proj.extra.saved': '저장되었습니다. AI 답변에 바로 반영됩니다.',
    'proj.extra.remove': '삭제',
    'proj.extra.hasExtra': '추가 지식 있음',
    'proj.extra.toggle': '추가 지식 입력',
    ...
    'admin.projects.enabled': '사용 중',
    'admin.projects.disabled': '사용중지됨',
    'admin.projects.userToggleConfirm': "'{email}' 계정을 {action}하시겠습니까?",
    'admin.projects.userEnabled': "'{email}' 계정을 사용재개했습니다.",
    'admin.projects.userDisabled': "'{email}' 계정을 사용중지했습니다.",
    'admin.projects.userToggleFailed': '계정 상태 변경에 실패했습니다.',
    'admin.projects.selfNote': '(현재 로그인된 내 계정)',
    ...
    'admin.projects.resetMenus': '빠른메뉴 편집 초기화',
    'admin.projects.resetMenusConfirm': "'{name}' 프로젝트의 빠른메뉴 질문 편집 1회 제한을 초기화하시겠습니까? 사용자가 다시 편집할 수 있게 됩니다.",
    'admin.projects.resetMenusDone': "'{name}' 빠른메뉴 편집 제한이 초기화되었습니다.",
    'admin.projects.resetMenusFailed': '빠른메뉴 편집 초기화에 실패했습니다.',
  ...
  en: {
    ...
    'signup.codePlaceholder': 'Signup code (8 characters)',
    ...
    'prof.ipGuard.title': 'Use IP allowlist',
    'prof.ipGuard.note': 'When off, per-user allowed-IP checks are skipped. Turn off on PaaS (e.g. Render) where client IPs are hard to identify behind proxies.',
    'prof.ipGuard.on': 'IP allowlist enabled.',
    'prof.ipGuard.off': 'IP allowlist disabled. (all IPs allowed)',
    'prof.save': 'Save',
    'prof.saving': 'Saving...',
    ...
    'proj.extra.title': 'Per-page extra knowledge',
    'proj.extra.note': 'Add up-to-date info per page that crawling missed or the site does not have yet (events, pricing, booking rules). Saved instantly into AI free-question and page-search answers.',
    'proj.extra.placeholder': 'e.g. Sep 2026 event — first consultation free. Book via Kakao channel "OO".',
    'proj.extra.save': 'Save extra knowledge',
    'proj.extra.saving': 'Saving...',
    'proj.extra.saved': 'Saved. Applied to AI answers immediately.',
    'proj.extra.remove': 'Delete',
    'proj.extra.hasExtra': 'Has extra knowledge',
    'proj.extra.toggle': 'Add extra knowledge',
    ...
    'admin.projects.enabled': 'Active',
    'admin.projects.disabled': 'Disabled',
    'admin.projects.userToggleConfirm': "{action} the account '{email}'?",
    'admin.projects.userEnabled': "Account '{email}' enabled.",
    'admin.projects.userDisabled': "Account '{email}' disabled.",
    'admin.projects.userToggleFailed': 'Failed to update account status.',
    'admin.projects.selfNote': '(your current account)',
    ...
    'admin.projects.resetMenus': 'Reset Quick Menu Edit',
    'admin.projects.resetMenusConfirm': "Reset the one-time quick menu question edit limit for project '{name}'? The user will be able to edit again.",
    'admin.projects.resetMenusDone': "Quick menu edit limit reset for '{name}'.",
    'admin.projects.resetMenusFailed': 'Failed to reset quick menu edit limit.',
